package com.example.ksram_beep.ui.theme

import androidx.compose.ui.graphics.Color

val SramRed = Color(0xFFE21D38)
val SramDarkRed = Color(0xFFA51227)
val GearGrey = Color(0xFF424242)
val DarkBackground = Color(0xFF1A1C1E)
val LightBackground = Color(0xFFFCFCFF)

val PrimaryLight = Color(0xFFBC162E)
